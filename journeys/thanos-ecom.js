/**
 * NirvanaTraffic — Thanos Ecom Journey
...
async function run(job) {
  ...
  if (!bitlyUrl) {
    ...
    return { success: false, error: "No Bitly URL", journeyType: "thanos-ecom", duration_ms: 0 };
  }
  ...
  try {
    ...
    return {
      ...
      journeyType: "thanos-ecom", fingerprint: session?.fingerprint || null,
      personality: personality ? { traits: personality.traits, timeOfDay: personality.timeOfDay, device: personality.device } : null,
